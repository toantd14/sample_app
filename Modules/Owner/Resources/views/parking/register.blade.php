...
@section('content')
    <div class="register-parking pt-3">
        ...
        @endif
        <form method="POST" action="{{ route('parkinglot.store') }}" class="form-register form-check-code"
              enctype="multipart/form-data">
            @csrf
            <div class="form-group d-flex pl-1">
                <label class="w-15 w-xs-25 pt-2 pl-5 font-weight-normal">名称<b class="text-danger">*</b></label>
            ...
            <div class="box-border-top border pt-1 pl-1">
                <div class="form-group d-flex flex-wrap">
                    <label class="w-15 w-xs-25 pl-5 pt-2 pr-1 font-weight-normal">住所 <b class="text-danger mr-2">*</b><span
                ...
                <div class="d-flex flex-wrap ">
                    <div class="w-60 w-xs-100">
                        <div class="form-group d-flex">
                            <label for="latitude" class="w-xs-25 w-25 pl-5 pt-2 font-weight-normal">緯度<b
                            ...
                            @else
                                <div class="w-75">
                                    <input id="latitude" value="{{ old('latitude') }}" name="latitude" type="text"
                                           class="form-control">
                                </div>
                            @endif
                        </div>
                        <div class="form-group d-flex">
                            ...
                            @else
                                <div class="w-75">
                                    <input id="longitude" value="{{ old('longitude') }}" name="longitude" type="text"
                                           class="form-control">
                                </div>
                            @endif
                        </div>
            ...
            <div class="form-group d-flex d-flex pl-1 mt-1">
                <label class="w-xs-25 w-15 pl-5 pt-2 font-weight-normal">電話番号<b
                        class="text-danger">*</b></label>
            ...
            <div class="form-group d-flex flex-wrap pl-1">
                <label class="w-xs-25 w-15 pl-5 pt-2 font-weight-normal">営業時間<b
                        class="text-danger mr-2">*</b></label>
                ...
                <div class="w-15 w-xs-100 ml-2 pt-2 ">
                    <input type="checkbox" {{old('sales_division') ? 'checked' : ''}} name="sales_division"
                           class="ml-xs-25">
            ...
            <div class="form-group d-flex flex-wrap pl-1">
                <div class="w-60 w-xs-100 ">
                    <div class="form-group d-flex flex-wrap">
                        ...
                        <label class="pt-2 w-25 pl-5 font-weight-normal">入庫<b class="text-danger">*</b></label>
                            ...
                            <div class="w-25 w-xs-45">
                                <div class="form-group">
                                    <div class="input-group date input-group-append" id="lu_start_time"
                                         data-target-input="nearest">
                                        <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off"
                                               class="timepicker form-control input-group-append"
                                               name="lu_start_time" value="{{ old('lu_start_time') }}"
                                        />
                                    </div>
                                </div>
                            ...
                            <div class="w-25 w-xs-45">
                                <div class="form-group">
                                    <div class="input-group date input-group-append" id="lu_end_time"
                                         data-target-input="nearest">
                                        <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off"
                                               class="timepicker form-control input-group-append bg-danger"
            ...
            <div class="form-group d-flex pl-1">
                <label class="w-15 w-xs-25 pl-5 pt-2 font-weight-normal">再入庫可</label>
                <div class="w-15 w-xs-100 ml-2 pt-2 ">
                    <input type="checkbox" name="re_enter" class="ml-xs-25" {{ old('re_enter') ? 'checked' : '' }}>
                </div>
            </div>
            <div class="form-group d-flex pl-1">
                <label class="w-15 w-xs-25 pl-5 pt-2 font-weight-normal">現地清算</label>
                <div class="w-15 w-xs-100 ml-2 pt-2 ">
            ...
            <div class="form-group d-flex pl-1">
                <label class="w-15 w-xs-25 pl-5 pt-2 font-weight-normal">ネット決済</label>
                <div class="w-15 w-xs-100 ml-2 pt-2 ">
                    <input type="checkbox" name="net_payoff" class="ml-xs-25" {{ old('net_payoff') ? 'checked' : '' }}>
                </div>
            </div>
            <div class="form-group d-flex pl-1">
                <label class="w-15 w-xs-25 pl-5 pt-2 font-weight-normal">注意事項</label>
                <div class="w-45 w-xs-75">
                    <textarea name="warn" class="form-control" rows="3">{{ old('warn') }}</textarea>
                </div>
            </div>
                        ...
                        <div class="col-6 col-md-3 text-center p-xs-1">
                            ...
                            <div id="filePreviewEdit1" class="p-2 file-preview-area2 file-preview-area">
                                <img class="img-upload-preview1 img-preview"
                                     src=""
                                     alt="preview uploaded file" width="200px">
            ...
            <div class="mt-4 w-100">
                ...
                <div class="form-group text-center">
                    <button type="button" data-toggle="modal" data-target="#modelCancelRegisterParkinglot"
