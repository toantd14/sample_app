...
@section('content')
    <div class="card-warning">
        <div class="card-body pl-0 pr-0">
            ...
            @endif
            @if (session('error'))
                <p class="p-2 alert-default-success text-danger">{{ session('error') }}</p>
            @endif
            @include('owner::slotsParking.modal_parking_exist')
            <div class="box-add">
                <form id="from-create" method="POST" action="{{ route('slots-parking.store') }}" role="form" class="form-slot-parking">
                    @csrf
                    <input type="hidden" name="parking_cd" value="{{ $parkingCd }}">
                    <div class="form-group row">
                        <label class="col-4 col-md-2   label-text font-weight-normal">駐車場形式 <b class="text-danger">*</b></label>
                    ...
                    <div class="form-group row">
                        <label class="label-text col-4 col-md-2   font-weight-normal">車種 <b class="text-danger">*</b></label>
                        <div class="col-8 col-md-10">
                            ...
                            @if ($errors->any() && $errors->has('car_type'))
                                <p class="mb-0 text-danger parking-form error">{{ $errors->first('car_type') }}</p>
                            @endif
                    ...
                    <div class="form-group row">
                        <label class="col-2   col-md-2 font-weight-normal label-text">車幅 <b class="text-danger">*</b></label>
                        ...
                        <label class="col-2   col-md-2 font-weight-normal label-text">車長 <b class="text-danger">*</b></label>
                        <div class="col-3 col-md-2">
                    ...
                    <div class="form-group row">
                        <label class="col-2   col-md-2 font-weight-normal label-text">車高 <b class="text-danger">*</b></label>
                        <div class="col-3 col-md-2">
                        ...
                        <label class="col-1 col-md-1 font-weight-normal">m</label>
                        <div class="offset-md-2"></div>
                        <label class="col-2   col-md-2 font-weight-normal label-text">車重 <b class="text-danger">*</b></label>
                        <div class="col-3 col-md-2">
                    ...
                    <div class="form-group row">
                        <label class="col-2   font-weight-normal label-text">記号 </label>
                        <div class="col-3 col-md-2">
                    ...
                    <div class="form-group row">
                        <label class="col-2   font-weight-normal label-text">駐車番号 <b class="text-danger">*</b></label>
            ...
            <div class="mt-4 d-flex mb-4">
                @if ($slotParkings->currentPage() != 1)
                    <a href="{{ $slotParkings->previousPageUrl() }}" class="ml-auto btn btn-primary mr-2"> < </a>
                @else
                    <span class="ml-auto btn btn-primary mr-2 disabled"> < </span>
                @endif
                @if ($slotParkings->currentPage() != $slotParkings->lastPage())
                    <a href="{{ $slotParkings->nextPageUrl() }}" class="btn btn-primary"> > </a>
                @else
            ...
            <div class="table col-12">
                <div class="row">
                    <div class="cell text-center col-2 col-lg-1">No</div>
                    <div class="cell text-center col-2 col-lg-1">記号</div>
                    <div class="cell text-center col-2 col-lg-1">番号</div>
                    <div class="cell text-center col-2 col-lg-1">普通</div>
                    <div class="cell text-center col-2 col-lg-1">３ナンバ</div>
                    <div class="cell text-center col-2 col-lg-1">軽自</div>
                    <div class="cell text-center col-2 col-lg-1">車幅</div>
                    <div class="cell text-center col-2 col-lg-1">車長</div>
                    <div class="cell text-center col-2 col-lg-1">車高</div>
                    <div class="cell text-center col-2 col-lg-1">車重</div>
                    <div class="cell text-center col-4 col-lg-2"></div>
                </div>
                @foreach($slotParkings as $index => $slotParking)
                    <div class="row" id="slot-parking-serial-no-{{$slotParking->serial_no}}">
                        ...
                        <div class="cell text-center col-2 col-lg-1">{{ $index + $slotParkings->firstItem() }}</div>
                        ...
                        <div class="cell text-center col-4 col-lg-2">
                            <button data-serial-no="{{ $slotParking->serial_no }}"
                                link="{{ route('slots-parking.show', ['slots_parking' => $slotParking->serial_no]) }}"
                            ...
                            <div class="modal fade" id="deleteModal{{ $slotParking->serial_no }}" tabindex="-1"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST"
                                                  action="{{ route('slots-parking.destroy', ['slots_parking' => $slotParking->serial_no ]) }}">
...
@section('js')
    ...
    <script src="{{ mix('/js/validate_slot_parking.js') }}"></script>
    <script src="{{ mix('/js/create_slot_parking.js') }}"></script>
