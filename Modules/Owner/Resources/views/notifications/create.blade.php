...
@section('content')
    <div class="notifications-page">
        <div class="notifications-page-content mt-4">
            ...
            @endif
            <form action="{{ route('notifications.store') }}" method="POST" id="form-notifications" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12"><h2>新規お知らせ登録</h2></div>
                </div>
                <div class="row mt-2">
                    <label class="col-sm-2 col-form-label pl-5">お知らせ日 <span class="field_required">*</span></label>
                    <div class="col-12 col-sm-2">
                        <input type="text" class="form-control datepicker" name="created_at" placeholder="{{ config('constants.DATE.INPUT_PLACEHOLDER_FORMAT') }}"
                               value="{{ old('created_at') }}" autocomplete="off">
                    ...
                    <div class="col-12 col-sm-2">
                        <input class="text-center form-control" name="announce_period" value="{{ old('announce_period') }}">
                        ...
                        <select class="form-control" name="parking_cd">
                            ...
                            @foreach($parkings as $parking)
                                <option
                                    ...
                                    @if($parking->parking_cd == old('parking_cd'))
                                        selected
                ...
                <div class="row form-group">
                    ...
                    <div class="col-10 mt-2">
                        <textarea name="notics_details" rows="14">{{ old('notics_details') }}</textarea>
                ...
                <div class="row action justify-content-center mt-4">
                    <div class="col-sm-2">
                        <button id="notifications-confirm" class="text-white d-block btn btn-primary mt-2">登録</button>
                    </div>
                    <div class="col-sm-2">
