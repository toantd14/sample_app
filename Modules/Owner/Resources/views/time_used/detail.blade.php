...
@section('content')
    ...
    <div class="box-detail border mt-4">
        ...
        <div class="box-middle row p-3">
            ...
            <div class="col-md-2 col-8">
                <label class="d-block">{{ $useSituation->reservation_day }}</label>
            </div>
            ...
            <div class="col-md-6 col-8">
                <label class="d-block">{{ $useSituation->parking_fee }} <label class="mr-2" for="">円</label></label>
            </div>
            <div class="col-md-2 col-4">
        ...
        @if($useSituation->reservation_use_kbn === \App\Models\UseSituation::RESERVATION)
            <hr>
        <div class="box-middle row p-3">
            <div class="col-md-2 col-4">
                <label class="d-block">予約日</label>
            ...
            <div class="col-md-6 col-8">
                <label class="d-block"> {{ $useSituation->money_reservation }}<label for="">円</label> </label>
            </div>
            <div class="col-md-2 col-4">
    ...
    <div class="form-group mt-4 text-center">
        <a href="{{ URL::previous() == URL::current() ? route('time-used.index') : URL::previous() }}" class="text-white btn btn-secondary px-5">戻る</a>
    </div>
@endsection
