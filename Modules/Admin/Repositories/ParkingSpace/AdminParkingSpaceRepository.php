...
class AdminParkingSpaceRepository extends RepositoryAbstract implements AdminParkingSpaceRepositoryInterface
{
    ...
    public function getAllSlotParking($parkingCd)
    {
        ...
        return $this->model->slotParking($parkingCd)->orderBy('space_symbol', 'ASC')
