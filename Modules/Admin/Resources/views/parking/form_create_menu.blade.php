                ...
                <div class="form-group row period_timeflg disable-div">
                    ...
                    <div class="col-md-10">
                        <div class="d-flex period_time">
                            <div>
                                <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off" name="period_fromtime" class="timepicker form-control d-inline-block w-auto">
                            </div>
                            &nbsp;~&nbsp;
                            <div>
                                <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off" name="period_totime" class="timepicker form-control d-inline-block w-auto">
                            </div>
                        </div>
                        ...
                        <div class="d-flex">
                            <div class="" style="width: 22%">
                                <input name="from_time" class="timepicker form-control d-inline-block"
                                        type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off">
                                <p class="text-danger from_time_error mb-2 mt-2"></p>
                            </div>
                            &nbsp;~&nbsp;
                            <div class="mr-2" style="width: 22%">
                                <input name="to_time" class="timepicker form-control d-inline-block" type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off">
