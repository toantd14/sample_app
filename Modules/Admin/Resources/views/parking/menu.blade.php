...
<div class="create-menu-page mt-4">
    <div class="row">
        <div class="col-md-2 col-3">
            <span class="ml-3" for="">オーナー名</span>
        </div>
        <div class="col-md-10 col-9">
            <p>{{ $parking->owner->name_c }}</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-2 col-3">
            ...
            <div class="row">
                ...
                <div class="col-md-10 input-check-day">
                    <div class="form-group row">
                        ...
                        <lable class="col-md-2 col-2">円／日</lable>
                    </div>
                    <div class="form-group row m-0">
            ...
            <div class="row">
                ...
                <div class="col-md-10 input-check-period">
                    <div class="form-group row period_week">
                        <div class="col-md-2 col-4 period_week_switch">
                            <label class="mr-2" for="">
                                <input name="period_week" value="{{ \App\Models\ParkingMenu::PERIOD_WEEK_FLG_ENABLE }}" type="checkbox" {{ $parking->parkingMenu->period_week == App\Models\ParkingMenu::PERIOD_WEEK_FLG_ENABLE ? 'checked' : '' }}>
                        ...
                        <div class="col-md-10 col-8 checkbox-day-of-week {{ $parking->parkingMenu->period_week== App\Models\ParkingMenu::PERIOD_WEEK_FLG_DISABLE ? 'disable-div' : '' }}">
                            <label class="mr-2" for="">
                                <input name="period_week_data[0]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data0" {{ $parking->parkingMenu->period_monday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                月
                            </label>
                            <label class="mr-2" for="">
                                <input name="period_week_data[1]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data1" {{ $parking->parkingMenu->period_tuesday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                火
                            </label>
                            <label class="mr-2" for="">
                                <input name="period_week_data[2]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data2" {{ $parking->parkingMenu->period_wednesday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                水
                            </label>
                            <label class="mr-2" for="">
                                <input name="period_week_data[3]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data3" {{ $parking->parkingMenu->period_thursday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                木
                            </label>
                            <label class="mr-2" for="">
                                <input name="period_week_data[4]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data4" {{ $parking->parkingMenu->period_friday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                金
                            </label>
                            <label class="mr-2" for="">
                                <input name="period_week_data[5]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data5" {{ $parking->parkingMenu->period_saturday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                土
                            </label>
                            <label class="mr-2" for="">
                                <input name="period_week_data[6]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data6" {{ $parking->parkingMenu->period_sunday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                日
                            </label>
                            <label class="mr-2" for="">
                                <input name="period_week_data[7]" value="{{ \App\Models\ParkingMenu::PARKING_MENU_ON }}" type="checkbox" id="period_week_data7" {{ $parking->parkingMenu->period_holiday == App\Models\ParkingMenu::PARKING_MENU_ON ? 'checked' : '' }}>
                                <label class="label-checkbox"></label>
                                祝
                            </label>
                    ...
                    <div class="form-group row period_timeflg disable-div">
                        <div class="col-md-2">
                            <label class="mr-2" for="">
                                <input name="period_timeflg" value="{{ \App\Models\ParkingMenu::PERIOD_TIME_FLG_ENABLE }}" type="checkbox" {{ $parking->parkingMenu->period_timeflg == App\Models\ParkingMenu::PERIOD_TIME_FLG_ENABLE ? 'checked' : ''}}>
                                <label class="label-checkbox"></label>
                                時間条件
                            </label>
                        </div>
                    ...
                    <div class="form-group row period_dayflg">
                        <div class="col-md-2">
                            <label class="mr-2">
                                <input name="period_dayflg" value="{{ \App\Models\ParkingMenu::PERIOD_DAY_FLG_ENABLE }}" type="checkbox" {{ $parking->parkingMenu->period_dayflg == App\Models\ParkingMenu::PERIOD_DAY_FLG_ENABLE ? 'checked' : ''}}>
                                <label class="label-checkbox"></label>
                                日付指定
                            </label>
                        </div>
                    ...
                    <div id="table">
                        <table class="table table-bordered border-0 text-center">
                            ...
                            <tbody>
                                ...
                                <tr class="tr{{$no}}">
                                    <th class="text-center th-no">
                                        {{ $no }}
                                        <input hidden name="data[{{$no}}][id]" value="{{ $time->id ?? '' }}">
                                    </th>
                                    <th class="text-center th-day-type">
                                    ...
                                    <th class="text-center th-from-to-time">
    ...
    <div class="row justify-content-center">
        <a href="{{ route('parkings.index') }}" class="col-md-2 btn btn-secondary text-center mx-2 mt-4">駐車場登録へ</a>
        <a href="{{ route('admin.index') }}" class="col-md-2 btn btn-secondary text-center mx-2 mt-4">戻る</a>
    </div>
    @else
...
@section('js')
<script>
    var urlCreateOrUpdateDay = "{{ route('menus-admin.day.create_or_update') }}";
    var urlCreateOrUpdateMonth = "{{ route('menus-admin.month.create_or_update') }}";
    var urlCreateOrUpdatePeriod = "{{ route('menus-admin.period.create_or_update') }}";
    var urlUpdateFlg = '{{ route("menus-admin.update_menu_flg") }}';
    ...
    var urlCreateOrUpdateMenuTime = '{{ route("menus-admin.time.create_or_update") }}';
    var dayTypeContent = {
...
<script src="{{ mix('/js/admin/admin-ajax-form-menu.js') }}"></script>
