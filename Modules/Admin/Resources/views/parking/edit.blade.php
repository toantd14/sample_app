...
<div class="register-parking pt-3">
    ...
    @endif
    <form method="POST" action="{{ route('parkings.update',  $parking->parking_cd) }}" class="form-register form-check-code" enctype="multipart/form-data">
        ...
        <div class="form-group pl-1 d-flex">
            ...
            <div class="w-45 w-xs-75">
                <select name="owner_cd" class="form-control">
                    ...
                    <option value="{{ $owner->owner_cd }}" @if(old('owner_cd')) selected @elseif($parking->owner_cd == $owner->owner_cd)
                        selected
                        @endif
                        >
                        {{ $owner->name_c }}
        ...
        <div class="form-group pl-1 d-flex disable-flg">
            ...
            <div class="w-45 w-xs-75 form-inline">
               @if ($parking->mgn_flg == App\Models\ParkingLot::MGN_FLG_ENABLE)
                <input class="role" type="radio" name="mgn_flg" value="0" checked><label class="mr-3 ml-1">提携先</label>
                <input class="role" type="radio" name="mgn_flg" value="1"><label class="mr-3 ml-1">提携外</label>
               @else
                <input class="role" type="radio" name="mgn_flg" value="0"><label class="mr-3 ml-1">提携先</label>
                <input class="role" type="radio" name="mgn_flg" value="1" checked><label class="mr-3 ml-1">提携外</label>
               @endif
            </div>
        </div>
        ...
        <div class="form-group d-flex pl-1">
            ...
            @else
            <div class="w-45 w-xs-75">
                <input type="text" value="{{ old('name') ?? $parking->parking_name }}" name="name" class="form-control">
            </div>
            @endif
        </div>
        <div class="box-border-top border pt-1 pl-1">
            <div class="form-group d-flex flex-wrap">
                ...
                <div class="w-25 w-xs-100">
                    <input type="text" value="{{ old('code') ?? $parking->zip_cd }}" name="code" class="form-control zip_code" placeholder="{{ config('constants.ZIPCOD_PLACEHOLDER') }}">
                </div>
                @endif
            </div>
            <div class="form-group d-flex flex-wrap">
                ...
                <div class="w-25 w-xs-50">
                    <input type="text" value="{{ old('prefectures') ?? $prefecturesName }}" name="prefectures" class="form-control prefectures">
                </div>
                @endif
            ...
            <div class="form-group d-flex flex-wrap">
                ...
                @else
                <div class="w-25 w-xs-50">
                    <input type="text" value="{{ old('municipality') ?? $parking->municipality_name }}" name="municipality" class="form-control municipality_name">
                </div>
                @endif
                <label class="w-xs-100 pt-2 font-weight-normal ml-xs-25">
                    （市区町村郡）
            ...
            <div class="form-group d-flex flex-wrap">
                ...
                @else
                <div class="w-25 w-xs-50">
                    <input type="text" value="{{ old('town_area') ?? $parking->townname_address }}" name="town_area" class="form-control townname_address">
                </div>
                @endif
            ...
            <div class="form-group d-flex flex-wrap">
                ...
                <div class="w-25 w-xs-50">
                    <input type="text" value="{{ old('building_name') ?? $parking->building_name }}" name="building_name" class="form-control">
                </div>
            ...
            <div class="d-flex flex-wrap ">
                <div class="w-60 w-xs-100">
                    <div class="form-group d-flex">
                        ...
                        @else
                        <div class="w-75">
                            <input id="latitude" value="{{ old('latitude') ?? $parking->latitude }}" name="latitude" type="text" class="form-control">
                        </div>
                        @endif
                    </div>
                    <div class="form-group d-flex">
                        ...
                        @else
                        <div class="w-75">
                            <input id="longitude" value="{{ old('longitude') ?? $parking->longitude }}" name="longitude" type="text" class="form-control">
                        </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="form-group d-flex pl-1 mt-1">
            ...
            @else
            <div>
                <input type="text" value="{{ old('tel_no') ?? $parking->tel_no }}" placeholder="ハイフン無しで入力" name="tel_no" class="form-control">
            </div>
            @endif
            <div>
            </div>
        ...
        <div class="form-group d-flex pl-1">
            ...
            <div class="w-15 w-xs-25">
                <input name="fax_no" value="{{ old('fax_no') ? old('fax_no') : $parking->fax_no }}" type="text" class="form-control bg-danger">
                <p class="mb-0 text-danger parking-form error">{{ $errors->first('fax_no') }}</p>
            </div>
            @else
            <div class="w-15 w-xs-25">
                <input name="fax_no" value="{{ old('fax_no') ?? $parking->fax_no }}" type="text" class="form-control">
            </div>
            @endif
        </div>
        <div class="form-group d-flex flex-wrap pl-1">
            <label class="w-xs-25 w-15 pt-2 font-weight-normal">営業時間<b class="text-danger float-right mr-2">*</b></label>
            ...
            <div class="w-15 w-xs-25">
                <div class="form-group">
                    <div class="input-group date input-group-append" id="sales_start_time" data-target-input="nearest">
                        <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off" class="timepicker form-control" name="sales_start_time" value="{{ old('sales_start_time') ?? $parking->sales_start_time }}" />
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="w-15 w-xs-25">
                <div class="form-group">
                    <div class="input-group date input-group-append" id="sales_end_time" data-target-input="nearest">
                        <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off" class="timepicker form-control" name="sales_end_time" value="{{ old('sales_end_time') ?? $parking->sales_end_time }}" />
                    </div>
                </div>
            </div>
            @endif
            <div class="w-15 w-xs-100 ml-2 pt-2 ">
                <input type="checkbox" name="sales_division" @if((!(old('sales_start_time') || old('sales_end_time')) && $parking->sales_division == App\Models\ParkingLot::SALES_DIVISION_ENABLE) || old('sales_division'))
                {{ 'checked' }}
                @endif
                class="ml-xs-25">
        ...
        <div class="form-group d-flex flex-wrap pl-1">
            <div class="w-60 w-xs-100 ">
                <div class="form-group d-flex flex-wrap">
                    ...
                    <div class="w-25 w-xs-45">
                        <div class="form-group">
                            <div class="input-group date input-group-append" id="lu_start_time" data-target-input="nearest">
                                <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off" class="timepicker form-control" name="lu_start_time" value="{{ old('lu_start_time') ?? $parking->lu_start_time }}" />
                            </div>
                        </div>
                    </div>
                    @endif
                ...
                <div class="form-group d-flex flex-wrap">
                    ...
                    <div class="w-25 w-xs-45">
                        <div class="form-group">
                            <div class="input-group date input-group-append" id="lu_end_time" data-target-input="nearest">
                                <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off" class="timepicker form-control bg-danger" name="lu_end_time" value="{{ old('lu_end_time') }}" />
                            </div>
                        </div>
                    ...
                    <div class="w-25 w-xs-45">
                        <div class="form-group">
                            <div class="input-group date input-group-append" id="lu_end_time" data-target-input="nearest">
                                <input type="text" placeholder="{{ config('constants.TIME.INPUT_PLACEHOLDER_FORMAT') }}" autocomplete="off" class="timepicker form-control" name="lu_end_time" value="{{ old('lu_end_time') ?? $parking->lu_end_time }}" />
                            </div>
                        </div>
                    </div>
                    @endif
            ...
            <div class="w-40 w-xs-100">
                <div class="ml-2 pt-2 float-xs-right">
                    <input type="checkbox" name="lu_division" @if(!(old('lu_start_time') || old('lu_end_time')) && $parking->lu_division === App\Models\ParkingLot::LU_DIVISION_ENABLE || old('lu_division'))
                    {{ 'checked' }}
                    @endif
                    />
        ...
        <div class="form-group d-flex pl-1">
            ...
            <div class="w-15 w-xs-100 ml-2 pt-2 ">
                <input type="checkbox" name="re_enter" class="ml-xs-25" {{ old('re_enter', $parking->re_enter) ? 'checked' : '' }}>
            </div>
        </div>
        <div class="form-group d-flex pl-1">
            <label class="w-15 w-xs-25 pt-2 font-weight-normal">現地清算</label>
            <div class="w-15 w-xs-100 ml-2 pt-2 ">
                <input type="checkbox" name="local_payoff" class="ml-xs-25" {{ old('local_payoff', $parking->local_payoff) ? 'checked' : '' }}>
            </div>
        </div>
        <div class="form-group d-flex pl-1">
            <label class="w-15 w-xs-25 pt-2 font-weight-normal">ネット決済</label>
            <div class="w-15 w-xs-100 ml-2 pt-2 ">
                <input type="checkbox" name="net_payoff" class="ml-xs-25" {{ old('net_payoff', $parking->net_payoff) ? 'checked' : '' }}>
            </div>
        </div>
        <div class="form-group d-flex pl-1">
            <label class="w-15 w-xs-25 pt-2 font-weight-normal">注意事項</label>
            <div class="w-45 w-xs-75">
                <textarea name="warn" class="form-control" rows="3">{{ old('warn') ?? $parking->warn }}</textarea>
            </div>
        </div>
        ...
        <div class="tab-content border-top-0 border pb-2">
            <div id="image" class="container tab-pane active">
                <div class="row mt-2">
                    <div class="col-6 col-md-3 text-center p-xs-1">
                        <div class="d-flex justify-content-center align-items-center" @if($parking->image1_url)
                            ...
                            <input type="file" id="btnEditInputUpload1" name="image[1]" class="file-input-images1 file-input-images" accept="image/*" value="{{ $parking->image1_url ?? '' }}" image="1">
                            <input type="text" name="isUpdateImage[0]" id="isUpdateImage1" class="input-is-update" value="0">
                        </div>
                        <div id="filePreviewEdit1" class="p-2 file-preview-area2 file-preview-area" @if($parking->image1_url)
                            style="display: block"
                            @endif>
                            <img class="img-upload-preview1 img-preview" src="{{ $parking->image1_url ? asset('storage/'.$parking->image1_url) : '' }}" alt="preview uploaded file">
                    ...
                    <div class="col-6 col-md-3 text-center p-xs-1">
                        <div class="d-flex justify-content-center align-items-center" @if($parking->image2_url)
                            style="display: none !important;"
                            @endif
                            id="div-input-image2"
                            >
                            ...
                            <input type="file" id="btnEditInputUpload2" name="image[2]" class="file-input-images2 file-input-images" accept="image/*" value="{{ $parking->image2_url ?? '' }}" image="2">
                            <input type="text" name="isUpdateImage[1]" id="isUpdateImage2" class="input-is-update" value="0">
                        </div>
                        <div id="filePreviewEdit2" class="p-2 file-preview-area2 file-preview-area" @if($parking->image2_url)
                            style="display: block"
                            @endif>
                            <img class="img-upload-preview2 img-preview" src="{{ $parking->image2_url ? asset('storage/'.$parking->image2_url) : '' }}" alt="preview uploaded file">
                    ...
                    <div class="col-6 col-md-3 text-center p-xs-1">
                        <div class="d-flex justify-content-center align-items-center" @if($parking->image3_url)
                            style="display: none !important;"
                            @endif
                            id="div-input-image3"
                            >
                            ...
                            <input type="file" id="btnEditInputUpload3" name="image[3]" class="file-input-images3 file-input-images" accept="image/*" value="{{ $parking->image3_url ?? '' }}" image="3">
                            <input type="text" name="isUpdateImage[2]" id="isUpdateImage3" class="input-is-update" value="0">
                        </div>
                        <div id="filePreviewEdit3" class="p-2 file-preview-area2 file-preview-area" @if($parking->image3_url)
                            style="
                            display: block"
                            @endif>
                            <img class="img-upload-preview3 img-preview" src="{{ $parking->image3_url ? asset('storage/'.$parking->image3_url) : '' }}" alt="preview uploaded file">
                    ...
                    <div class="col-6 col-md-3 text-center p-xs-1">
                        <div class="d-flex justify-content-center align-items-center" @if($parking->image4_url)
                            style="display: none !important;"
                            @endif
                            id="div-input-image4"
                            >
                            ...
                            <input type="file" id="btnEditInputUpload4" name="image[4]" class="file-input-images4 file-input-images" accept="image/*" value="{{ $parking->image4_url ?? '' }}" image="4">
                            <input type="text" name="isUpdateImage[3]" id="isUpdateImage4" class="input-is-update" value="0">
                        </div>
                        <div id="filePreviewEdit4" class="p-2 file-preview-area2 file-preview-area" @if($parking->image4_url)
                            style="display: block"
                            @endif>
                            <img class="img-upload-preview4 img-preview" src="{{ $parking->image4_url ? asset('storage/'.$parking->image4_url) : '' }}" alt="preview uploaded file">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-3 text-center p-xs-1">
                            <div class="d-flex file-1">
                                <div class="d-flex justify-content-center align-items-center" @if($parking->video1_url)
                                    style="display: none !important;"
                                    @endif
                                    id="div-input-video1"
                                    >
                            ...
                            <div id="videoPreview1" class="p-2 video-preview-area1 video-preview-area" @if($parking->video1_url)
                                style="display: block"
                                @endif
                                >
                        ...
                        <div class="col-6 col-md-3 text-center p-xs-1">
                            <div class="d-flex file-2">
                                <div class="d-flex justify-content-center align-items-center" @if($parking->video2_url)
                                    style="display: none !important;"
                                    @endif
                                    id="div-input-video2"
                                    >
                            ...
                            <div id="videoPreview2" class="p-2 video-preview-area2 video-preview-area" @if($parking->video2_url)
                                style="display: block"
                                @endif
                                >
                        ...
                        <div class="col-6 col-md-3 text-center p-xs-1">
                            <div class="d-flex file-3">
                                <div class="d-flex justify-content-center align-items-center" @if($parking->video3_url)
                                    style="display: none !important;"
                                    @endif
                                    id="div-input-video3"
                                    >
                            ...
                            <div id="videoPreview3" class="p-2 video-preview-area1 video-preview-area" @if($parking->video3_url)
                                style="display: block"
                                @endif
                                >
                        ...
                        <div class="col-6 col-md-3 text-center p-xs-1">
                            <div class="d-flex file-4">
                                <div class="d-flex justify-content-center align-items-center" @if($parking->video4_url)
                                    style="display: none !important;"
                                    @endif
                                    id="div-input-video4"
                                    >
                            ...
                            <div id="videoPreview4" class="p-2 video-preview-area4 video-preview-area" @if($parking->video4_url)
                                style="display: block"
                                @endif
                                >
        ...
        <div class="mt-4 w-100">
            ...
            <div class="form-group text-center">
                <button type="button" data-toggle="modal" data-target="#modelCancelEditParkinglot" class="btn btn-secondary w-25 py-3 w-xs-50">
                    キャンセル
                </button>
            </div>
        </div>
