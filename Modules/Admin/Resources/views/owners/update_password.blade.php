        ...
        <div class="card-body">
            ...
            <form id="form-reset-password">
                ...
                <div class="form-group row">
                    <a href="{{ route('owners.edit', ['owner' => $ownerCD]) }}" class="ml-auto col-lg-3 col-sm-3 btn btn-primary mt-4 mr-2">
                        会員情報
                    </a>
                    <a href="{{ route('owner-banks.edit', ['id' => $ownerCD]) }}" class="col-lg-3 col-sm-3 btn btn-primary mt-4">
                        口座情報
                    </a>
                </div>
                @csrf
