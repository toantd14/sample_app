        ...
        <div class="card-body">
            ...
            <form id="form-owner-bank">
                ...
                <div class="form-group row">
                    <a href="{{ route('owners.create') }}" class="ml-auto col-lg-3 col-5 btn btn-primary mt-4 mr-2">
                        会員情報
                    </a>
                    <a href="{{ route('owner-password.create', ['owner' => $ownerCD]) }}" class="col-lg-3 col-5 btn btn-primary mt-4">
                        パスワード変種
                    </a>
                </div>
                @csrf
                ...
                <div class="form-group row mt-5">
                    <label class="offset-lg-1 col-lg-2 col-5 pt-2 pl-4 font-weight-normal">金融機関名<b class="text-danger">*</b></label>
                ...
                <div class="form-group row">
                    <label class="offset-lg-1 col-lg-2 col-5 pt-2 pl-4 font-weight-normal">金融機関コード <b class="text-danger">*</b></label>
                ...
                <div class="form-group row">
                    <label class="offset-lg-1 col-lg-2 pt-2 pl-4 col-5 font-weight-normal">支店名<b class="text-danger">*</b></label>
                    <div class="col-lg-7 col-7">
                ...
                <div class="form-group row">
                    <label class="offset-lg-1 col-lg-2 pl-4 pt-2 col-5 font-weight-normal">支店コード<b class="text-danger">*</b></label>
                    <div class="col-lg-3 col-4">
                ...
                <div class="form-group row">
                    <label class="offset-lg-1 col-lg-2 col-5 pl-4 pt-2 font-weight-normal">口座種別</label>
                    <div class="col-lg-8 col-7">
                        @if(!isset($ownerBank))
                            <input class="role" type="radio" name="account_type" value="{{ \App\Models\OwnerBank::TYPE_NORMA }}" checked>
                            <label class="mr-3 ml-1">普通</label>
                            <input class="role" id="company" name="account_type" value="{{ \App\Models\OwnerBank::TYPE_PAYMENT }}" type="radio">
                            <label class="mr-3 ml-1">当座</label>
                        @elseif ($ownerBank->account_type == \App\Models\OwnerBank::TYPE_NORMA)
                            <input class="role" type="radio" name="account_type" value="{{ \App\Models\OwnerBank::TYPE_NORMA }}" checked>
                            <label class="mr-3 ml-1">普通</label>
                            <input class="role" id="company" name="account_type" value="{{ \App\Models\OwnerBank::TYPE_PAYMENT }}" type="radio">
                            <label class="mr-3 ml-1">当座</label>
                        @else
                            <input class="role" type="radio" name="account_type" value="{{ \App\Models\OwnerBank::TYPE_NORMA }}">
                            <label class="mr-3 ml-1">普通</label>
                            <input class="role" type="radio" id="company" name="account_type" value="{{ \App\Models\OwnerBank::TYPE_PAYMENT }}" checked>
                            <label class="mr-3 ml-1">当座</label>
                        @endif
                ...
                <div class="form-group row">
                    <label class="offset-lg-1 col-lg-2 col-5 pl-4 pt-2 font-weight-normal">口座名<b class="text-danger">*</b></label>
                    <div class="col-lg-7 col-7">
                ...
                <div class="form-group row">
                    <label class="offset-lg-1 col-lg-2 col-5 pt-2 pl-4 font-weight-normal">口座名フリガナ<b class="text-danger">*</b></label>
                    <div class="col-lg-7 col-7">
                ...
                <div class="form-group row">
                    <label class="offset-lg-1 col-lg-2 col-5 pt-2 pl-4 font-weight-normal">
                        口座番号
                    </label>
                    <div class="col-lg-7 col-7">
                ...
                @if(isset($updated) && isset($created))
                    <div class="form-group row">
                        <label class="offset-lg-1 col-lg-2 pl-4 font-weight-normal col-5">登録日</label>
                        <div class="col-lg-7 col-7">
                    ...
                    <div class="form-group row">
                        <label class="offset-lg-1 col-lg-2 col-5 pl-4 font-weight-normal">更新日</label>
                        <div class="col-lg-7 col-7">
                ...
                @else
                    <div class="form-group row">
                        <label class="offset-lg-1 col-lg-2 col-5 pl-4 font-weight-normal">登録日</label>
                        <div class="col-lg-7 col-7">
                ...
                <div class="form-group row">
                    ...
                    <button id="showConfirm" class="col-lg-2 col-sm-4 btn btn-primary mt-4">
                        登録
                    </button>
                    <div class="col-lg-1 col-sm-1"></div>
                    <a href="{{ route('owners.index') }}" class="text-white col-lg-2 col-sm-4 btn btn-secondary mt-4">
                        キャンセル
                    </a>
