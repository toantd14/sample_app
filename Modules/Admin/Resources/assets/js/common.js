...
$(".date_picker_only_month").datepicker()
    .on('show', function () {
        $('.datepicker-months thead th').text('');
        $('.datepicker-months th').css('height', '0px');
        $('.datepicker-months thead').css('pointer-events', 'none');
    })

$(document).ready(function () {
    let linkPrev = $('#paginate-page .page-item:first-child a').attr('href');
    let linkNext = $('#paginate-page .page-item:last-child a').attr('href');
